<script>
    ...
    function odabraniMain(id, odabran) {
        if ($('#'+id).length === 0) {
            ...
            var obrisiOdabranog = "<a class='obrisiOdabranog' id='obrisi"+id+"'>"+ odabran +"</a>";
...
echo '
<div class="tr">
    <div class="td">'.$row['MAIN'].'<button onclick="odabraniMain(\''.$row['id'].'\', \''.$row['MAIN'].'\');" class="plus"><i class="fas fa-plus"></i></button></div>
</div>
';
        }
    }
