    ...
    <script>
        ...
        $(function() {
            for (cokolada_td_br=1; cokolada_td_br<=25; cokolada_td_br++) {
                ...
                $('#cokolada'+cokolada_td_br).append(v_cokolada_container, v_spec_container, v_class_container);
            ...
            $(".cokolada_submenu_item").on("click", function() {
                ...
                $(this).closest(".cokolada_td").find('.class_container').append($(this).closest(".cokolada_menu_item").html());
