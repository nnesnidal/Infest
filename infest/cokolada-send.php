<?php
    ...
    $query = "UPDATE infest_lista_chars SET ICC='SAVED' WHERE ICC='FREE' AND MAIN='".$odabran."' AND (MS='".$spec."' OR OS='".$spec."') AND CLASS='".$spec_class."' ORDER BY FIELD(MS, '".$spec."') DESC LIMIT 1";
