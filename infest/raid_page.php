    ...
    <script>
        ...
        $(function() {
            for (cokolada_td_br=1; cokolada_td_br<=25; cokolada_td_br++) {
                ...
                if ([5, 10, 15, 20, 25].includes(cokolada_td_br)) {
                    $('#menu'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_dk'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_dr'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_ht'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_mg'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_pl'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_pr'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_rg'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_sh'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_wl'+cokolada_td_br).addClass('last_in_line');
                    $('#sub_wr'+cokolada_td_br).addClass('last_in_line');
                }
            ...
            $(".cokolada_submenu_item").on("click", function() {
                ...
                var main_dropdown_span = $(this).closest(".cokolada_td").find('.main_dropdown_span').html();
                $(this).closest(".cokolada_td").find('.main_dropdown_span').empty();
                $('.main_dropdown_menu_item').each(function(){
                    if ($(this).html() == main_dropdown_span) {
                        $(this).removeClass('hide_it');
                    }
                });
                $('.obrisiOdabranog').each(function(){
                    if ($(this).html() == main_dropdown_span && $(this).closest('.odabrani').hasClass("hide")) {
                        ...
                        success : function(data) {
                            if ($.trim(data) == '') {
                                ...
                                if ($('#'+id_cokolada_td).find('.main_dropdown_menu_item:contains("'+odabran+'")')){
                                    ...
                                    var main_dropdown_menu_item_span = $('#'+id_cokolada_td).find('.main_dropdown_menu_item:contains("'+odabran+'")');
                                    $('.main_dropdown_span').each(function(){
                                        if ($(this).html() == main_dropdown_menu_item_span.html()) {
                                            main_dropdown_menu_item_span.addClass('hide_it');
                                        }
                                    });
                                }
                            }
            ...
            $(".cokolada_redo_button").on("click", function() {
                $('.main_dropdown_span').each(function(){
                    var main_dropdown_span = $(this).html();
                    $(this).empty();
                    $('.main_dropdown_menu_item').each(function(){
            ...
            $(".cokolada_send_button").on("click", function() {
                $('.cokolada_td').each(function(){
                    var odabran = $(this).find('.main_dropdown_span').html();
                    var spec = $(this).find('.spec_container').html().replace("-", "").replace("-", "");
                    var spec_class = $(this).find('.class_container').html();
                    if (odabran != "") {
                        $.ajax({
                            type : "POST",
                            url : "cokolada-send.php",
                            data : {odabran: odabran, spec: spec, spec_class: spec_class},
                            success : function(data) {
                            }
                        });
...
<body>
    ...
    <div class="nav_container">
        ...
        <div class="cokolada_buttons">
        <button class="cokolada_send_button"><i class="far fa-check-circle fas_style"></i></button>
        <button class="cokolada_redo_button"><i class="fas fa-redo fas_style"></i></button>
        </div>
    </div> 
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <button class="reset_popup" onclick="resetModal();"><img class="refresh_img" src="img/refresh.png" alt=""></button>
